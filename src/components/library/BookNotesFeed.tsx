...
export default function BookNotesFeed({ userBookId, mediaId, notes, user, profile }: { userBookId: string, mediaId?: string, notes: any[], user: any, profile?: any }) {
  ...
  useEffect(() => {
    if (activeTab === 'COMMUNITY' && mediaId && communityMemos.length === 0) {
      ...
      getCommunityMemos(mediaId, 'BOOK').then(res => {
