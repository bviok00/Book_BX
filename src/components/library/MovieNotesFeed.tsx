...
export default function MovieNotesFeed({ userMovieId, mediaId, notes, user, profile }: { userMovieId: string, mediaId?: string, notes: any[], user: any, profile?: any }) {
  ...
  useEffect(() => {
    if (activeTab === 'COMMUNITY' && mediaId && communityMemos.length === 0) {
      ...
      getCommunityMemos(mediaId, 'MOVIE').then(res => {
