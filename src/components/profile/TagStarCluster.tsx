  ...
  return (
    ...
    >
      {tags.map((tag, i) => {
        ...
        const sizeMultiplier = Math.min(2.5, 1 + (tag.weight * 0.15));
        const opacity = Math.min(1, 0.5 + (tag.weight * 0.1));
        ...
        return (
          <span 
            ...
            style={{
              ...
              padding: `${4 * sizeMultiplier}px ${10 * sizeMultiplier}px`,
              ...
              boxShadow: `0 0 ${8 * sizeMultiplier}px ${accent}22`
            }}
            onMouseOver={(e) => {
